...
- Install latest portal
  ([`24b2c43`](https://github.com/codeforlife-education/rapid-router/commit/24b2c433f88dbba1b47b56ad69eb3092edca617d))
...
- Install latest package
  ([`c8c1b27`](https://github.com/codeforlife-education/rapid-router/commit/c8c1b27e679240e3fc95a47be6f20857bb6a7b83))
...
- Install latest package
  ([`150a4ab`](https://github.com/codeforlife-education/rapid-router/commit/150a4ab25df9f9a4ef9d2d8bb76e419e880a1fe4))
...
* feat: update modal display logic to avoid changes to the URL

* fix: remove dependency on modal display on URL change

* fix: update modal close link to prevent changes to URL
...
* delete unused banner image

* update python den student banner size

* add student banner to independent page
...
* Try using generic Python Snyk action
...
* Merge branch 'master' into python-den-game-page

* try getting rid of migration

* debug test - blockly_tab

* debug test - remove bundle

* debug test - remove defer from web component
...
* fix missing decor on level 30 and strange titles/descriptions on level 57-8
...
* feat: add popup message for delivery to non-destination

* feat: add failure sound and event for non-destination delivery

* feat: mark non-destination delivery as 0 points in level
...
* Merge branch 'master' into overwrite_modal
...
* added level command retrieval.

* changed commands tab so that it displays level specific commands.

* added commands for level 92.

* Added commands for levels 92-109.

* Added commands for levels 113-115.

* Added commands for levels 119-122.

* change size of font on commands popup.

* Improve formatting of commands on popup.

* removed unused variable.

* fix: handle NoneType for commands in play_level function

* Merge branch 'master' into master

* feat: add 2 extra commands to level 99 command popup

* feat: add extra command to level 100

* chore: remove extra whitespace

* feat: use default commands instead of empty string

* chore: remove unnecessary variable default_commands

* feat: change default value for commands in level model to full list of commands

* chore: remove whitespace in line 87
...
Bumps [setuptools](https://github.com/pypa/setuptools) from 65.5.1 to 70.0.0. - [Release
...
* Merge branch 'master' into add-electric-van-gauge

* add check to help debug test

* change test level name to avoid overlap

* run black

* add check for debugging test

* try out change to test

* change presence to visibility
...
* Merge branch 'custom-level-introduction-and-hint' into custom-level-introduction-hint-ui
...
* fix screen ratio to display whole grid
...
Bumps [eventlet](https://github.com/eventlet/eventlet) from 0.31.0 to 0.35.2. -
  ...
  [Commits](https://github.com/eventlet/eventlet/compare/v0.31.0...v0.35.2)

--- updated-dependencies: - dependency-name: eventlet dependency-type: indirect ...

Signed-off-by: dependabot[bot] <support@github.com>

* Merge branch 'master' into dependabot/pip/eventlet-0.35.2
...
* Merge branch 'master' into dev_container_set_up
...
Removed extra XML code that added a new block in level 14
...
Co-Authored-By: Seb Palmer <s.palmer1@ocado.com>
...
Co-Authored-By: Abdelrahman <abdelrahman.aboudeghedy@ocado.com>
...
Bumps [setuptools](https://github.com/pypa/setuptools) from 62.1.0 to 65.5.1. - [Release
  notes](https://github.com/pypa/setuptools/releases) -
  [Changelog](https://github.com/pypa/setuptools/blob/main/NEWS.rst) -
...
* Merge branch 'master' into Project-rapid-router

* Updated level_selection and game and uploaded code

* Merge branch 'Project-rapid-router' of https://github.com/karatmate/rapid-router into
  Project-rapid-router
...
* Merge branch 'master' into 1349-better-solution-for-lv-43
...
* Add reverse code to custom migration
...
Bumps [django](https://github.com/django/django) from 3.2.16 to 3.2.17. - [Release
  notes](https://github.com/django/django/releases) -
...
* feat: remove event listeners. Tidy migrations. Merge upstream.

* Merge branch 'master' into 1334-cow-condition-and-sound-horn

* fix: fix error in placing cow

* refactor: change migrations, formatting js

* merge

* chore: renumber migrations to catch up with master

* refactor: remove duplicate cow_crossing and sound_horn blocks

* fix: add python for sound_horn and fix pre-existing error on deliver
...
Bumps [django](https://github.com/django/django) from 3.2.15 to 3.2.16. - [Release
  notes](https://github.com/django/django/releases) -
...
* fix: adding a fix prefix to commit :)

* removed logs and reverted back some code
...
* Try updating pytest.ini settings

* Try renaming to test_settings

* Revert

* Try mirroring portal's config

* Try upgrading pytest
...
Bumps [django](https://github.com/django/django) from 3.2.14 to 3.2.15. - [Release
  notes](https://github.com/django/django/releases) -
...
* final fixes and add test

* clean up test

* addressing comments

* updating icons again

* pause icon change

* Merge branch 'master' into resizeble_window
...
* Allow admins to play custom levels in their school
...
* Merge master into main-method-101-104
...
* Merge branch 'master' into 1014-deleting-workspace-doesnt-have-any-feedback

* fix: 'this' 'undefined' in deleteWorkspace callback

* refactor: remove redundant step removing workspace from ui

* Merge branch '1014-deleting-workspace-doesnt-have-any-feedback' of github.com:sebp999/rapid-router
  into 1014-deleting-workspace-doesnt-have-any-feedback
...
* remove id from level 48 solution

* update level 48 solution
...
* remove Code for Life from title
...
* Merge branch 'master' into update_lockfile
...
* add from van import Van

* level 1 fix

* fix search errors and v.cow => my_van.cow
...
* Merge branch 'master' into crowdin-csp-2
...
* Try removing portal install from ci and bring back translations
...
* fix: Allow Crowdin in-context translation resources
...
This reverts commit ece66b0975b8f55c2310ccdfc1958ffd4a2f888b.

* Revert "fix: try different events (#1300)"

This reverts commit 20aa3609d7be69e44024ff9e1f8230c6b9389ea0.

* Revert "fix: publish (#1299)"

This reverts commit 9ce91437e6358d9670b38242106eff4794df82d4.

* Revert "fix: debug ci"

This reverts commit 40717fabd207bfe00afb88a7a62c33bbab2008b1.
...
* Merge branch 'master' into explement_snow
...
* code review and fix slider drag anywhere
...
Bumps [django](https://github.com/django/django) from 2.2.25 to 2.2.26. - [Release
  notes](https://github.com/django/django/releases) -
  [Commits](https://github.com/django/django/compare/2.2.25...2.2.26)
...
* Merge branch 'master' into level-moderation
...
* test_moderation_empty_class_filter

* remove duplicate RR_logo.svg

* move scoreboard search to the right

* scoreboard select all classes/episodes by default

* move RR logo to common

* test_moderation_shared_with
...
* Merge branch 'master' into fix_dropdowns

* No pointer on button padding
...
* Merge branch 'master' into indepsubnav
...
* Merge branch 'master' into dummy_branch

* fix: another dummy commit
...
* Add unsafe eval, icons and fix tests

* Cleanup

* Add autoconfig to coverage ignore list

* Install portal branches for tests

* Remove comment

* Install common branch properly

* Freeze to see state

* Try strings and fix typo

* No egg

* Try with commit hashes instad of branch name
...
* Split everything into stages

* Reuse strings

* Merge branch 'master' into csp_header

* Bundle commands back together

# Conflicts: #	.codecov.yml

* Split up steps again for debugging

* Re bundle steps

* Python 3.6 ro 3.7

* Remove report only line

* Remove redundant linters and custom installations

* Refactor congif and fix http link

* Fix common pipfile installation
...
* Update a few of the Python levels help texts

* Black formatter

* Remove all localisation from messages file and fix tests

* Remove obsolete tests

* Delete test locale directory

* Remove + signs and use f string
...
Bumps [sqlparse](https://github.com/andialbrecht/sqlparse) from 0.4.1 to 0.4.2. - [Release
  notes](https://github.com/andialbrecht/sqlparse/releases) -
  [Changelog](https://github.com/andialbrecht/sqlparse/blob/master/CHANGELOG) -
  [Commits](https://github.com/andialbrecht/sqlparse/compare/0.4.1...0.4.2)

--- updated-dependencies: - dependency-name: sqlparse dependency-type: indirect ...

Signed-off-by: dependabot[bot] <support@github.com>

* Update lockfile

* Merge branch 'master' into dependabot/pip/sqlparse-0.4.2
...
* Merge branch 'master' into 852-curviness-test
...
* fix: 1099, change javascript in level_moderation and include modal in page template
...
Bumps [pillow](https://github.com/python-pillow/Pillow) from 8.3.1 to 8.3.2. - [Release
  notes](https://github.com/python-pillow/Pillow/releases) -
...
This reverts commit 140ef3d43bd3d1501d77a47fc26c69746e2bd887.

* Revert "get portal and common from the custom branch"

This reverts commit 312f72b609fff288aba8308c4b03069a8e3e4c75.
...
* Fix error page to have padding

* Remove redundant error pages
...
* Merge branch 'rebranding-p1' into rebranding_p1_amends

# Conflicts: #	game/templates/game/level_moderation.html

* Update level moderation button styles

* Fix scoreboard header background
...
* replace glyphicons with material icons
...
* Remove save and load buttons if not logged in
...
Bumps [wagtail](https://github.com/wagtail/wagtail) from 2.11.7 to 2.11.8. - [Release
  notes](https://github.com/wagtail/wagtail/releases) -
  [Changelog](https://github.com/wagtail/wagtail/blob/main/CHANGELOG.txt) -
  [Commits](https://github.com/wagtail/wagtail/compare/v2.11.7...v2.11.8)

--- updated-dependencies: - dependency-name: wagtail dependency-type: indirect ...
...
* fix: put back grey panels

* docs: add ocado additional terms back
...
Bumps [django](https://github.com/django/django) from 2.2.22 to 2.2.24. - [Release
  notes](https://github.com/django/django/releases) -
...
* Merge branch 'master' into dependabot/pip/django-2.2.24
...
Bumps [django](https://github.com/django/django) from 2.2.21 to 2.2.22. - [Release
  notes](https://github.com/django/django/releases) -
...
Bumps [django](https://github.com/django/django) from 2.2.20 to 2.2.21. - [Release
  notes](https://github.com/django/django/releases) -
...
* Merge branch 'dependabot/pip/django-2.2.21' of https://github.com/ocadotechnology/rapid-router
  into dependabot/pip/django-2.2.21
...
Bumps [urllib3](https://github.com/urllib3/urllib3) from 1.26.4 to 1.26.5. - [Release
...
* Merge branch 'master' of github.com:ocadotechnology/rapid-router into
  1164-rr-homemade-levels-sharing

* test: add tests for default character and ensure editor of custom level is owner of level
...
* Merge branch 'master' into trigger-deploy-workflow
...
The copyright file was out of date and it was intruding github license detection
...
* more updates to readme and contributing

* Merge branch 'docsupdate' of https://github.com/ocadotechnology/rapid-router into docsupdate
...
* put back function, or the tests would time out
...
* feat: update python version to 3.7

* add exclusion list to codeclimate
...
Bumps [django](https://github.com/django/django) from 2.2.18 to 2.2.20. - [Release
  notes](https://github.com/django/django/releases) -
...
Bumps [django](https://github.com/django/django) from 2.2.17 to 2.2.18. - [Release
  notes](https://github.com/django/django/releases) -
  [Commits](https://github.com/django/django/compare/2.2.17...2.2.18)
...
* Put portal install back in ci workflow

* Move django-autconfig back to setup.py
...
* Remove pull request trigger on publishing package

* Merge branch 'master' into stop_retriggering
...
* Merge branch 'master' of github.com:ocadotechnology/rapid-router into
  997-all-teachers-can-see-all-classes-in-scoreboard

* chore: Modify formatting and couple of extra asserts in tests
...
* Merge branch 'master' into 638-level-75-solution
...
* fix: Updated migration for solution for level 50

* Merge branch 'master' into fix-level-50-solution

* chore: formatting

* Merge branch 'fix-level-50-solution' of github.com:sebp999/rapid-router into fix-level-50-solution

* feat: New destination and optimal solution

* fix: change date in migration

* feat: revise level solution
...
* use constant for overlay background color, re-jiggle animation timings

* update color error

* update chromedriver

* fix tests and popup no scroll bug

* Remove dead code

* test on master as well
...
* docs: Updated virtualenv section
...
* update rapid-router due to change in common

* require cfl-common version 4

* update travis dep in rapid router
...
* Install common and update foreign keys
...
* Reformat migration to fix code-climate
...
* Upgrade Chromedriver again

* Update dist and services to match portal config

* Install portal with -U

* Use same Chromedriver as portal

* Update chromedriver setup to match portal
...
* Use rest-framework views

* Update Chromedriver

* Rename view and update docstring

* Update last call to level sharing permission

* Switch parameters order back
...
* Ignore Jquery CSS files in CodeClimate

* Merge branch 'master' into scoreboard-progress-bar

# Conflicts: #	.codeclimate.yml
...
* Remove while true from random decor generation
...
* Merge branch 'master' into revert_rudolph
...
it was only used in some dead code
...
* Add g-recaptcha-response to post requests for login in tests
...
* Revert "fix: Remove django-appconf"

This reverts commit 985ddb2a4b200a4332621417834861f819729802.

* Revert "Revert "fix: Remove django-appconf""

This reverts commit 8a732e2eaa1664c7a8e98467a6903f5bfd5a1248.

* Merge branch 'master' into remove_appconf
...
* Revert "removed django-jquery"

This reverts commit eedf0671965130f29e36c064c9afa10c2b7262b7.

* removed django-jquery again

* disabled reCaptcha on tests
...
* Futurize test files and compilers files

* Merge branch 'master' into port_to_python_3

* futurize stage 2 with unicode literals

Signed-off-by: Niket <niket.shah1@ocado.com>

* install python-future

* Revert "futurize stage 2 with unicode literals"

This reverts commit 901176a76578ddd09ea0b119c4bf6d3cbc91717c.
...
Revert "Rapid Rudolph back to the North Pole - Fixes #942 (#943)"

This reverts commit cc7aac20b734bbd91d094d3be12552cbb973501d.

# Conflicts: #	game/theme.py

* Merge branch 'master' into rapid_rudolph_2019
...
Bumps [django-js-reverse](https://github.com/ierror/django-js-reverse) from 0.6.1 to 0.9.1. -
  ...
  [Commits](https://github.com/ierror/django-js-reverse/compare/v0.6.1...v0.9.1)
...
* pointed to portal upgrade branch

* Merge remote-tracking branch 'origin/master' into django111

* Merge branch 'master' into django111

* Initialise selenium in selenium test case

* use pytest

Signed-off-by: Niket Shah <masterniket@gmail.com>

* install dependencies from Pipfile on travis

* stop on fail for testing

* isntall lower version of selenium

* upgrade django selenium clean

* update code to be compatible with django selenium clean 0.3.2

* update chromedriver

* use staticliveservertestcase

* collect files anyways

* Use live server test case
...
* see what the login page looks like after the login fails

* put print on correct test

* add more travis debugging

* correct code split

* add more deubgging statements

* add more debugging

* always log on

* Revert "always log on"

This reverts commit abaac8c568ce27c72bb93b90572c10b95e66c91d.

* Extend teardown function to log out after tests end

* Revert "stop on fail for testing"

This reverts commit 7db4b277c74430dbd322aee28e024021ec3cb104.

# Conflicts: #	.travis.yml #	Pipfile.lock

* Removed unnecessary libraries + move coverage to Travis only

* Bring back static collection

* dummy commit to unblock Travis
...
* Make chromedriver version match portal's

* Remove addon to match portal

* Revert to original chromedriver version for testing
...
* fix: prevent from panning the map when clicking on the green side menu
...
* Moved listener to initialiser. Also made event function anonymous.
...
* Make codeclimate ignore the blockly library
...
* Removes unnecessary imports and functions
...
* Merge branch 'master' into premature_email
...
* install deps in deploy and make test stage empty

* install more things for deployment (right now)

* remove versioneer and use semantic release

* install crowdin on deploy step and fix syntax error in setup.py

* fix import errors in setup.py

* fix version of python semantic release to a python 2 compatible one

* do not have an empty script section

* ci(test version bump):

BREAKING CHANGE: Testing breaking changes

* remove after success step
...
* Move angular parser locally to being to start supporting unicode characters

* fix commit_parser import

* make semantic_release_parser a module

* correct commit parser import

* remove custom commit parser

* fix(.travis.yml): Test automatic versioning

Add space to test version number is bumped up

* feat(.travis.yml): Make feat change to test bump

* fix(setup.cfg): Do not check build status

* fix(game/__init__.py): Bump up version to match latest release

* ci(versioning): Remove versioneer

* fix: test a patch update

* 1.0.2

* feat(versioning): Add semantic release functionality

Using semantic-release publish We skip tests on a tag build only deploy on master

* Delete custom angular parser

* docs(pull_requests): Update PR docs to reflect current processes

* docs(pull_requests): Add conventional commit spec to PR template

* docs(contributing): Update contributing guidelines

* docs(pull_request): Update PR template

* ci(travis): Update python patch version
...
- **pipeline**: Testing breaking changes
