    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "locked_for_class",
                    models.ManyToManyField(blank=True, related_name="locked_levels", to="common.class"),
                ),
                (
                    "next_level",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "locked_classes",
                    models.ManyToManyField(blank=True, related_name="locked_worksheets", to="common.class"),
                ),
            ],
        ),
        migrations.CreateModel(
