...
def change_levels(apps, schema_editor):
    ...
    level43.destinations = level41.destinations
    ...
    level41.destinations = level36.destinations
    ...
    level38 = Level(pk=38, name=38, destinations='[[6,0]]', default=1, model_solution=11,
