...
from codeforlife.models.fields.decorators import validated_field_setter
from codeforlife.types import Validators
...
class Workspace(EncryptedModel):
    ...
    name_validators: Validators = [MaxLengthValidator(200)]
