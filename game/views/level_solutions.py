...
solutions = {
    ...
    "48": '<xml xmlns="http://www.w3.org/1999/xhtml"><block type="start" id="A~vmJT1hDRH93daDfto+" deletable="false" x="415" y="678"><next><block type="controls_repeat" id="v.Whj@(nJ/An;~#[TsFC"><field name="TIMES">4</field><statement name="DO"><block type="controls_repeat_until" id="um51^*nIr?g.%R?YJhJF"><value name="condition"><block type="at_destination" id=";=EP7J1}_Im0Q]~ZU)Z]"></block></value><statement name="body"><block type="controls_if" id="Ie`p9Kfxu1(#Vb{3lp66"><mutation elseif="4"></mutation><value name="IF0"><block type="traffic_light" id="R%VRKKXGN:MuX/ew)Gf}"><field name="CHOICE">RED</field></block></value><statement name="DO0"><block type="wait" id="3`:Xm/sR9Uhh4;TsI{aB"></block></statement><value name="IF1"><block type="road_exists" id="Sr`/`g(F,YeD-e+Vw/*O"><field name="CHOICE">LEFT</field></block></value><statement name="DO1"><block type="turn_left" id="1tavLY=%YVS^V$Ue1G2Q"></block></statement><value name="IF2"><block type="road_exists" id="HUund@1Ma_@)|7}:cT#j"><field name="CHOICE">FORWARD</field></block></value><statement name="DO2"><block type="move_forwards" id="[pm^h5Txcd!SN%=m{VfV"></block></statement><value name="IF3"><block type="road_exists" id="J]sgU:j%m0KikKw=Y4P5"><field name="CHOICE">RIGHT</field></block></value><statement name="DO3"><block type="turn_right" id="E/t|W!cgYVJGYTm$JyFM"></block></statement><value name="IF4"><block type="dead_end" id="i|13.JEZIAgTH~6[QfSf"></block></value><statement name="DO4"><block type="turn_around" id=";tJX/zUv)(n0I([Aiw@B"></block></statement></block></statement><next><block type="deliver" id="zK88%s%iI%Z7Va`rObh?"></block></next></block></statement></block></next></block></xml>',
