...
solutions = {
    ...
    "66": '<xml xmlns="http://www.w3.org/1999/xhtml"><block type="start" deletable="false" x="110" y="-459"><next><block type="call_proc"><field name="NAME">double_straight_right</field><next><block type="turn_left"><next><block type="call_proc"><field name="NAME">triple_straight_right</field><next><block type="call_proc"><field name="NAME">double_straight_right</field><next><block type="call_proc"><field name="NAME">triple_straight_right</field><next><block type="turn_left"><next><block type="call_proc"><field name="NAME">double_straight_right</field></block></next></block></next></block></next></block></next></block></next></block></next></block></next></block><block type="declare_proc" x="298" y="-383"><field name="NAME">double_straight_right</field><statement name="DO"><block type="move_forwards"><next><block type="move_forwards"><next><block type="turn_right"></block></next></block></next></block></statement></block><block type="declare_proc" x="265" y="-196"><field name="NAME">triple_straight_right</field><statement name="DO"><block type="move_forwards"><next><block type="call_proc"><field name="NAME">double_straight_right</field></block></next></block></statement></block></xml>',
    ...
    "74": '<xml xmlns="http://www.w3.org/1999/xhtml"><block type="start" deletable="false" x="479" y="542"><next><block type="call_proc"><field name="NAME">straight_left</field><next><block type="call_proc"><field name="NAME">backtrack_left</field><next><block type="call_proc"><field name="NAME">backtrack_left</field><next><block type="controls_repeat"><field name="TIMES">2</field><statement name="DO"><block type="call_proc"><field name="NAME">straight_left</field></block></statement></block></next></block></next></block></next></block></next></block><block type="declare_proc" x="641" y="583"><field name="NAME">backtrack_left</field><statement name="DO"><block type="turn_right"><next><block type="call_proc"><field name="NAME">straight_left</field><next><block type="turn_around"><next><block type="turn_left"></block></next></block></next></block></next></block></statement></block><block type="declare_proc" x="611" y="778"><field name="NAME">straight_left</field><statement name="DO"><block type="move_forwards"><next><block type="turn_left"></block></next></block></statement></block></xml>',
