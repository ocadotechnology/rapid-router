...
class TestCrashes(BaseGameTest):
    def test_crash_turning_left_on_straight_road(self):
        self.run_crashing_test(level=6, workspace_file='crash_turning_left_on_straight_road')
    ...
    def test_crash_going_left_on_t_junction(self):
        self.run_crashing_test(level=40, workspace_file='crash_going_left_on_t_junction')
