...
class TestLevelEditor(BaseGameTest):
    ...
    def test_cow_on_origin(self):
        ...
        house_space = self.selenium.find_elements(By.CSS_SELECTOR, "rect[fill='#ff0000']")
    ...
    def test_cow_on_house(self):
        ...
        forbidden_end_space = self.selenium.find_elements(By.CSS_SELECTOR, "rect[x='330'][y='530']")
        print(forbidden_end_space[0].get_attribute("fill"))
