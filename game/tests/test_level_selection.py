...
class LevelSelectionTestCase(TestCase):
    ...
    def test_list_episodes(self):
        ...
        self._assert_that_response_contains_level_with_title(response, 'Can you help the van get to the house? ')
    ...
    def _assert_that_response_contains_level_with_title(self, response, expected):
        assert_that(response.context['episodeData'][0]['levels'][0]['title'], equal_to(expected))
